...
//			select ".bss.Cpu0_Main.g_AppCpu0";
		...
		group (ordered, contiguous, align = 8, run_addr = mem:edmem)
		{
			select ".bss.LQ_VoiceProcess.g_adc0Data";
			select ".bss.LQ_VoiceProcess.g_adc1Data";
			select ".bss.LQ_VoiceProcess.g_adc2Data";
			select ".bss.LQ_VoiceProcess.g_adc3Data";
			
			select ".bss.Core.In1";	
			select ".bss.Core.In2";	
			select ".bss.Core.In3";
			select ".bss.Core.In4";
			select ".bss.Core.Out2";
			select ".bss.Core.Out3";
			
//			select ".bss.Core.TEMP";
//			select ".bss.Core.TEMP_";
//			select ".bss.Core.TEMPOUT_";
//			select ".bss.Core.FM_OUT";
//			select ".bss.Core.MIC_OUT";
		}
	}
	/*Near data sections*/
