...
//龙邱TFT SPI口模块管脚顺序
#define TFTSPI_CS       P20_8    // CS管脚 默认拉低，可以不用
#define TFTSPI_SCK      P15_1    // SPI SCK管脚
...
#include <LQ_QSPI.h>
#include <LQ_SPI.h>
#define USE_QSPI  0     //不使用硬件SPI接线方式    如果使用硬件SPI  则CS接P21_2  SCK接P00_2   SDI接P00_1  DC接P20_12  RST接P20_13
