...
//    	TFTSPI_P8X16Str(1,1,txt_main,u16WHITE,u16BLACK);		//字符串显示
//    	sprintf(txt_main,"y:%02f",vec.y);
//    	TFTSPI_P8X16Str(1,2,txt_main,u16WHITE,u16BLACK);		//字符串显示
//    	sprintf(txt_main,"z:%02f",vec.z);
//    	TFTSPI_P8X16Str(1,3,txt_main,u16WHITE,u16BLACK);		//字符串显示

//    	sprintf(txt_main,"x_:%02f",offset.x);
//    	TFTSPI_P8X16Str(1,4,txt_main,u16WHITE,u16BLACK);		//字符串显示
//    	sprintf(txt_main,"y_:%02f",offset.y);
//    	TFTSPI_P8X16Str(1,5,txt_main,u16WHITE,u16BLACK);		//字符串显示
//    	sprintf(txt_main,"z_:%02f",offset.z);
//    	TFTSPI_P8X16Str(1,6,txt_main,u16WHITE,u16BLACK);		//字符串显示
	}
}
