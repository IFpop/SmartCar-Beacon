...
static uint32_t distance[7] = {0,0,0,0,0,0,0};
...
//	ANO_DT_send_int16((int)distance[1],(int)distance[2],(int)distance[3],(int)distance[4],(int)distance[5],(int)distance[6],0,0);
	...
	// TFTSPI_P8X16Str(1,0,txt,u16WHITE,u16BLACK);		//字符串显
	// sprintf(txt,"d5:%d",distance[2]);
	// TFTSPI_P8X16Str(1,1,txt,u16WHITE,u16BLACK);		//字符串显
	// sprintf(txt,"d6:%d",distance[3]);
	// TFTSPI_P8X16Str(1,2,txt,u16WHITE,u16BLACK);		//字符串显
	// sprintf(txt,"d4:%d",distance[4]);
	// TFTSPI_P8X16Str(1,3,txt,u16WHITE,u16BLACK);		//字符串显
	// sprintf(txt,"d5:%d",distance[5]);
	// TFTSPI_P8X16Str(1,4,txt,u16WHITE,u16BLACK);		//字符串显
	// sprintf(txt,"d6:%d",distance[6]);
	// TFTSPI_P8X16Str(1,5,txt,u16WHITE,u16BLACK);		//字符串显
