...
extern volatile       signed short encValue1;
extern volatile		signed short encValue3;
extern volatile		signed short encValue4;
extern volatile		signed short encValue5;
